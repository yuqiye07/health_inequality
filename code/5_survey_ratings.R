# this script cleans survey data and calculate the average rating for categories
...
m <- read_csv("data/matching_labels.csv")
...
# define a function to calculate the average rating within 2 stds and 95%C.I.
# for each category
...
# normalize the average rating using min max standardisation
